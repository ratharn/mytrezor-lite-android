...
public class LobbyActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        if (WalletService.mIsRunning) {
            ...
            String filePrefix = "mytrezor-lite"; // FIXME - Also in WalletService
            String path = filePrefix + ".hdreceive";	// FIXME - WalletService
            ...
            if (walletFile.exists()) {
                ...
                Intent intent = new Intent(this, ScanXPubActivity.class);
                startActivity(intent);
            }
        }
